...
The above used to send submit button. 
Writing the Xpath in simple way
//tagname[@attribute ='value'] 
example - //input[@type ='submit']
For writing the css selector -
tagname[attribute = 'value']

Assert:- Assert will check wether the message is correct or not
"""
message = browser.find_element(By.XPATH,"/html/body/app-root/form-comp/div/div[2]/div").text
print(message)
